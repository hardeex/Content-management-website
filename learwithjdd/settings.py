"""
Django settings for learwithjdd project.
...
WSGI_APPLICATION = 'learwithjdd.wsgi.application'
...
LOGIN_REDIRECT_URL = 'index:blog_list'
...
EMAIL_HOST_PASSWORD = 'ebjgwphzemdoxvkq'  # Replace with your email password
EMAIL_USE_TLS = True
